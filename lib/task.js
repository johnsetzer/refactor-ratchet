...
Task.prototype.src = function (options, srcCallback) {
  ...
  .spread(function (changedFiles) {
    ...
    this.mostRecentPaths = _.intersection(this.mostResenctPaths, this.gitTrackedPaths);
    this.mostRecentPaths = _.difference(this.mostResenctPaths, this.changedPaths);

    // gitTracked - mostRecent - changed
    this.untrackedPaths = _.difference(this.gitTrackedPaths, this.mostResenctPaths);
