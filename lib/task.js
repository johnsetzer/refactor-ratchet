...
Task.prototype.calcStats = function () {
	...
	_.extend(this.totalMetrics, this.listStats(keyVals, this.key));

	var lineCountVals = _.pluck(this.fileMetrics, 'lineCount');
	_.extend(this.totalMetrics, this.listStats(lineCountVals, 'lineCount'));

	return this.totalMetrics;
}

Task.prototype.listStats = function (list, key) {
	var metrics = {};
	var sum = 0;
